...
/**
 * @covers \Nethgui\Client\ViewCommandSequence
 */
class ViewCommandSequenceTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @var \Nethgui\Client\ViewCommandSequence
     */
    protected $object;
    ...
    {
        $this->origin = $this->getMock('Nethgui\Core\ViewInterface');
        $selector = 'Selector';

        $this->object = new \Nethgui\Client\ViewCommandSequence($this->origin, $selector);
    }
