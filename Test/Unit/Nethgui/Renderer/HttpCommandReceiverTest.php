 ...
 *
 */
class Nethgui_Renderer_HttpCommandReceiverTest extends PHPUnit_Framework_TestCase
{

    /**
     * @var Nethgui_Renderer_HttpCommandReceiver
     */
    protected $object;
    ...
    protected function setUp()
    {
        ...
        $this->object = new Nethgui_Renderer_HttpCommandReceiver($view);
    ...
    {
        $mock = $this->getMockBuilder('Nethgui_Core_GlobalFunctionWrapper')
