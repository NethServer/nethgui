<div id="NotificationArea" class="NotificationArea"><div class="notification-dialog LoadingMessage ui-state-highlight ui-corner-all" style="display: none"><span class="notification-icon ui-icon ui-icon-transfer-e-w" ></span><span class="message"><?php echo T('Please wait...'); ?></span></div><?php 
